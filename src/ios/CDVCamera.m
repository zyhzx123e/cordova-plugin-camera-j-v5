            ...
            [AVCaptureDevice requestAccessForMediaType:AVMediaTypeVideo completionHandler:^(BOOL granted)
             {
                 if(!granted)
                 {
                     ...
                     dispatch_async(dispatch_get_main_queue(), ^{
                         ...
                         [weakSelf.viewController presentViewController:alertController animated:NO completion:nil];
                     });
                 } else {
...
- (void)showCameraPicker:(NSString*)callbackId withOptions:(CDVPictureOptions *) pictureOptions
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        //cameraPicker.webView = self.webView;//Jason added comment solve the crash issue
...
- (void)cleanup:(CDVInvokedUrlCommand*)command
{
     ...
     @catch (NSException *exception) {
        NSLog(@"cleanup err: %@", exception.reason);
     }
     @finally {
        NSLog(@"cleanup Finally done");
     }
...
- (NSData*)processImage:(UIImage*)image info:(NSDictionary*)info options:(CDVPictureOptions*)options
{
    ...
    @catch (NSException *exception) {
       NSLog(@"processImage err: %@", exception.reason);
    }
    @finally {
       NSLog(@"processImage Finally done");
    }
...
- (UIImage*)retrieveImage:(NSDictionary*)info options:(CDVPictureOptions*)options
{
    ...
    @catch (NSException *exception) {
       NSLog(@"retrieveImage err%@", exception.reason);
    }
    @finally {
       NSLog(@"retrieveImage Finally done");
    }
...
- (void)resultForImage:(CDVPictureOptions*)options info:(NSDictionary*)info completion:(void (^)(CDVPluginResult* res))completion
{
    ...
    @catch (NSException *exception) {
       NSLog(@"resultForImage err: %@", exception.reason);
    }
    @finally {
       NSLog(@"resultForImage Finally done");
    }
}
...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary*)info
{
    ...
    if (cameraPicker.pictureOptions.popoverSupported && (cameraPicker.pickerPopoverController != nil)) {
        [cameraPicker.pickerPopoverController dismissPopoverAnimated:NO];
...
- (void)imagePickerControllerReturnImageResult
{
     ...
     @catch (NSException *exception) {
        NSLog(@"imagePickerControllerReturnImageResult catch err: %@", exception.reason);
     }
     @finally {
        NSLog(@"Finally jason done");
     }
