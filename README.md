...
This plugin is a folk of cordova-plugin-camera 5.0.2 with fixes on cordova webview optimization in IOS & Memory enhancement in Android - Jason
...
This requires cordova 5.0+
    ...
    cordova plugin add cordova-plugin-camera-alwaysmktv5
